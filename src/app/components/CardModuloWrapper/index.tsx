...
//   if (loading) {
//     return <p className="text-center text-gray-600 animate-pulse">Carregando módulo...</p>
//   }
...
//   if (!modulo) {
//     return <p className="text-center text-gray-500">Módulo não encontrado.</p>
//   }
...
//           {modulo.subTitulo || 'Subtítulo do módulo'}
//         </p>
...
//           {modulo.descricao || 'Descrição breve sobre o conteúdo do módulo.'}
//         </p>
//       </div>

//       {etapaConcluida >= modulo.order && (
//         <div className="flex gap-4">
//           <a href={`/modulo/${modulo.id}`} className="watchVideo">
