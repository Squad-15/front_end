        ...
        <section className="main-content w-full ml-0 md:ml-20 px-6">
          <header className="z-0 sticky top-0 pt-4">
            <div
              ...
              <div className="flex items-center flex-wrap z-50 w-full">
                ...
                <div className="flex items-center gap-8 ml-auto">
                  <div className="flex items-center space-x-6">
                    <svg xmlns="http://www.w3.org/2000/svg"
                      className="w-5 h-5 cursor-pointer fill-slate-800 hover:fill-[#077bff]" viewBox="0 0 511 511.999">
                      <path
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                      className="w-5 h-5 cursor-pointer fill-slate-800 hover:fill-[#077bff]" viewBox="0 0 371.263 371.263">
                      <path
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                      className="w-5 h-5 cursor-pointer fill-slate-800 hover:fill-[#077bff]" viewBox="0 0 24 24">
                      <path
