...
>
  ...
  <div className="headings *:text-center *:leading-4">
    <p className="text-xl font-serif font-semibold text-[#434955]">Ryan Nardelli</p>
    <p className="text-sm font-semibold text-[#434955]">Analista de TI</p>
  </div>
  ...
  >
    ...
    <li>
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <path d="M3 13h18v-2H3v2zm0 4h12v-2H3v2zM3 5v2h18V5H3z" />
      </svg>
    ...
    <li>
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <path d="M16 11V5h-1V3H9v2H8v6H2v10h20V11h-6zm-6 0V7h4v4h-4z" />
      </svg>
      <p>Analista de TI</p>
    </li>
