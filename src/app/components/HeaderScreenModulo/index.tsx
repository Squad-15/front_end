// export const HeaderScreenModulo = () => {
//     return (
          ...
          <nav className="flex flex-col lg:flex-row lg:gap-x-8 items-center">
            <ul className="flex flex-col gap-4 lg:flex-row lg:gap-x-8 text-center">
              ...
              <a
                ...
                pathname === '/modulo' ? 'text-[#BC1F1B]' : 'hover:text-[#BC1F1B]'
                }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <a
                  href="/path"
                  className={`flex items-center gap-2 font-bold text-[15px] ${
                  pathname === '/path' ? 'text-[#BC1F1B]' : 'hover:text-[#BC1F1B]'
                }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <a
                  href="/ranking"
                  className={`flex items-center gap-2 font-bold text-[15px] ${
                  pathname === '/ranking' ? 'text-[#BC1F1B]' : 'hover:text-[#BC1F1B]'
                }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <a
                  href="/shop"
                  className={`flex items-center gap-2 font-bold text-[15px] ${
                  pathname === '/shop' ? 'text-[#BC1F1B]' : 'hover:text-[#BC1F1B]'
                }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <a
                  href="/profile"
                  className={`flex items-center gap-2 font-bold text-[15px] ${
                  pathname === '/profile' ? 'text-[#BC1F1B]' : 'hover:text-[#BC1F1B]'
                }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
