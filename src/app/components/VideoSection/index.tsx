...
const VideoSection: React.FC<VideoSectionProps> = ({ youtubeUrl }) => {
  ...
  const videoId = convertToVideoId(youtubeUrl);
  ...
  return (
    <section className="max-w-2xl px-4 py-4 bg-white dark:bg-gray-900 flex flex-col justify-center items-center min-h-screen">
      <button
